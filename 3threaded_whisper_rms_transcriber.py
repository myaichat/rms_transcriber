...
from rms_transcriber import whisper_AsyncTranscriber as    AsyncTranscriber
from rms_transcriber.include.transcriber.whisper.AsyncTranscriber import transcribe
...
async def main():
    ...
    if 1:        
        ...
        long_running_thread = threading.Thread(target=transcribe, args=())
